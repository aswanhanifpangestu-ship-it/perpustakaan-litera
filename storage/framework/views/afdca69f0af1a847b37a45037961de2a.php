...
<div class="summary">
    <div class="sbox amber" style="width:25%">
        <div class="val"><?php echo e($totalPetugas); ?></div>
        <div class="lbl">Total Petugas</div>
    </div>
    <div class="sbox red" style="width:25%">
        <div class="val"><?php echo e($totalAdmin); ?></div>
    ...
    <div class="sbox" style="width:25%">
        <div class="val" style="color:#64748b"><?php echo e($totalNonaktif); ?></div>
...
<table class="main">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?php echo e($p->created_at->format('d/m/Y')); ?></td>
            <td class="text-center"><?php echo e($p->peminjaman_diproses); ?></td>
        </tr>
...
<?php /**PATH C:\Users\aswan\Downloads\perpuss\resources\views/laporan/pdf_petugas.blade.php ENDPATH**/ ?>