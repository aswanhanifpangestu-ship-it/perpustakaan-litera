...
unset($__errorArgs, $__bag); ?>"
            ...
            <div class="text-center small" style="color:#64748b">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="fw-bold text-decoration-none" style="color:#0d9488">
                    Daftar di sini ✨
                </a>
            </div>
        </div>
...
<?php /**PATH C:\Users\aswan\Downloads\perpuss\resources\views/auth/login.blade.php ENDPATH**/ ?>