...
<head>
<meta charset="UTF-8">
<title>Struk Peminjaman #<?php echo e(str_pad($peminjaman->id, 6, '0', STR_PAD_LEFT)); ?></title>
<style>
...
<div class="struk-title">
    ...
    <div class="no">No. #<?php echo e(str_pad($peminjaman->id, 6, '0', STR_PAD_LEFT)); ?></div>
</div>
...
?>
<div class="status-box <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></div>
...
<div class="denda-box <?php echo e($peminjaman->status_denda === 'sudah_bayar' ? 'denda-lunas' : 'denda-belum'); ?>">
    <div class="denda-row">
        <div class="denda-left">
            <div class="bold" style="font-size:10px">DENDA KETERLAMBATAN</div>
            <div style="color:#64748b;font-size:9px">
                <?php echo e($peminjaman->jumlah_hari_terlambat); ?> hari &times;
                Rp <?php echo e(number_format($peminjaman->buku->denda_per_hari, 0, ',', '.')); ?>

            </div>
        </div>
        <div class="denda-right">
            <div class="denda-amount">Rp <?php echo e(number_format($peminjaman->total_denda, 0, ',', '.')); ?></div>
...
<div class="ttd-section">
    <div class="ttd-box">
        <div>Anggota,</div>
        <div class="ttd-name"><?php echo e($peminjaman->user->name); ?></div>
        <div class="ttd-role">Anggota</div>
    </div>
    <div class="ttd-box">
        <div>Petugas,</div>
        <div class="ttd-name"><?php echo e($peminjaman->petugas->name ?? 'Petugas'); ?></div>
        <div class="ttd-role"><?php echo e(ucfirst($peminjaman->petugas->role ?? 'Petugas')); ?></div>
    </div>
</div>
...
<?php /**PATH C:\Users\aswan\Downloads\perpuss\resources\views/struk/pdf.blade.php ENDPATH**/ ?>