...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Litera'); ?> — Litera 📚</title>
...
<nav id="sidebar">
        ...
        <ul class="nav flex-column mt-1">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('kategori.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('kategori.*') ? 'active' : ''); ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('peminjaman.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('peminjaman.*') ? 'active' : ''); ?>">
                    <i class="bi bi-arrow-left-right"></i> 📋 Peminjaman
                </a>
            </li>
            <?php if(auth()->user()->isUser()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('peminjaman.index', ['status_denda' => 'belum_bayar'])); ?>"
                   class="nav-link <?php echo e(request()->is('peminjaman') && request('status_denda') === 'belum_bayar' ? 'active' : ''); ?>">
                    <i class="bi bi-cash-coin"></i> 💸 Denda Saya
                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('struk.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('struk.*') ? 'active' : ''); ?>">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('ulasan.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('ulasan.index') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-bottom">
        <?php echo $__env->make('notifications._sidebar_bell', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div class="sidebar-user">
            <div class="avatar"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></div>
            <div class="overflow-hidden">
                <div class="uname text-truncate"><?php echo e(auth()->user()->name); ?></div>
                <div class="urole">
                    <?php if(auth()->user()->isAdmin()): ?> 👑 <?php elseif(auth()->user()->isPetugas()): ?> 🛡️ <?php else: ?> 📖 <?php endif; ?>
    ...
    <div class="topbar">
        ...
        <div class="d-flex align-items-center gap-2">
            <span class="badge rounded-pill px-3 py-2
                <?php if(auth()->user()->isAdmin()): ?> badge-admin
                <?php elseif(auth()->user()->isPetugas()): ?> badge-petugas
...
<?php /**PATH C:\Users\aswan\Downloads\perpuss\resources\views/layouts/app.blade.php ENDPATH**/ ?>