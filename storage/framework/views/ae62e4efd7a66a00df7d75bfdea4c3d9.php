...
<div class="summary">
    ...
    <div class="sbox amber" style="width:25%">
        <div class="val"><?php echo e($totalDipinjam); ?></div>
        <div class="lbl">Sedang Dipinjam</div>
    </div>
    <div class="sbox" style="width:25%">
        <div class="val" style="color:#166534"><?php echo e($totalDikembalikan); ?></div>
...
<table class="main">
    ...
    <tbody>
        <?php $__empty_1 = true; $__currentLoopData = $peminjaman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <tr>
            ...
            <td class="text-center">
                ...
                ?>
                <span class="<?php echo e($badges[$p->status] ?? ''); ?>"><?php echo e($labels[$p->status] ?? $p->status); ?></span>
            </td>
            <td class="text-center">
            ...
            <td class="text-right">
                <?php if($p->total_denda > 0): ?>
                    <span style="color:#dc2626;font-weight:bold">Rp <?php echo e(number_format($p->total_denda, 0, ',', '.')); ?></span>
...
<?php /**PATH C:\Users\aswan\Downloads\perpuss\resources\views/laporan/pdf_peminjaman.blade.php ENDPATH**/ ?>