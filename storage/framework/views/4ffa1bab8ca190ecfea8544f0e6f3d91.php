        ...
        <div class="rounded border flex-shrink-0 position-relative overflow-hidden"
            ...
            <?php if($hasSampul): ?>
                <img id="sampulPreviewImg"
                     src="<?php echo e(Storage::disk('public')->url($currentSampul)); ?>"
        ...
        <div class="flex-grow-1">
            ...
            <div class="rounded-3 p-2 mb-2 small"
                ...
                <ol class="mb-0 ps-3">
                    ...
                    <li>Klik <strong><?php echo e($isEdit ? 'Perbarui' : 'Simpan'); ?> Buku</strong> untuk menyimpan</li>
                </ol>
            </div>
            ...
            <input type="file"
                   ...
                   class="form-control <?php $__errorArgs = ['sampul_buku'];
                    ...
                    <div class="d-flex gap-3 align-items-start">
                        ...
                        <div>
                            <div class="fw-semibold">
                                Klik <em><?php echo e($isEdit ? 'Perbarui' : 'Simpan'); ?> Buku</em>
                            </div>
                            <div class="small text-muted">
                                Klik tombol <strong><?php echo e($isEdit ? 'Perbarui' : 'Simpan'); ?> Buku</strong>
...
<?php if (! $__env->hasRenderedOnce('f96beeea-56df-489a-8d85-65f2404468c1')): $__env->markAsRenderedOnce('f96beeea-56df-489a-8d85-65f2404468c1'); ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\aswan\Downloads\perpuss\resources\views/buku/_sampul_upload.blade.php ENDPATH**/ ?>