    ...
    <div class="col-lg-9">
        ...
        <div class="card table-card">
            <div class="card-header py-3 d-flex align-items-center gap-2">
                ...
                <span class="ms-2 text-muted small text-truncate" style="max-width:300px">— {{ $buku->judul }}</span>
                <span class="ms-auto small text-muted"><span class="text-danger">*</span> wajib diisi</span>
            </div>
            <div class="card-body">
                <form action="{{ route('buku.update', $buku) }}" method="POST" enctype="multipart/form-data" novalidate>
                    @csrf @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="isbn"
                                       ...
                                       value="{{ old('isbn', $buku->isbn) }}" maxlength="20">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <div class="form-text">Tersedia saat ini: <strong>{{ $buku->stok_tersedia }}</strong></div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="denda_per_hari"
                                           ...
                                           value="{{ old('denda_per_hari', $buku->denda_per_hari) }}" min="0" step="500">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="lokasi_rak"
                                       ...
                                       value="{{ old('lokasi_rak', $buku->lokasi_rak) }}" maxlength="50">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="deskripsi" rows="3"
                                          ...
                                          placeholder="Deskripsi singkat...">{{ old('deskripsi', $buku->deskripsi) }}</textarea>
                                @error('deskripsi')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            @include('buku._sampul_upload', ['isEdit' => true, 'currentSampul' => $buku->sampul_buku])
                        </div>
                    </div>
