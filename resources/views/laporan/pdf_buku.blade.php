...
<table class="main">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $i + 1 }}</td>
            <td><strong>{{ $b->judul }}</strong>
                @if($b->isbn)<br><span style="color:#94a3b8;font-size:8px">ISBN: {{ $b->isbn }}</span>@endif
            </td>
            <td>{{ $b->pengarang }}</td>
            <td>{{ $b->penerbit }}</td>
